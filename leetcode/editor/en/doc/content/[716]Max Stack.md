...
<p>&nbsp;</p>
<strong>Follow up:</strong> Could you come up with a solution that supports <code>O(1)</code> for each <code>top</code> call and <code>O(logn)</code> for each other call?&nbsp;<div><div>Related Topics</div><div><li>Linked List</li><li>Stack</li><li>Design</li><li>Doubly-Linked List</li><li>Ordered Set</li></div></div><br><div><li>👍 1157</li><li>👎 316</li></div>